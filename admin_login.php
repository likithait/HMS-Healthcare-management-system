...
$sql = "select * from admin_login_data where name = '$name' and password = '$password'";  
...
<nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand" style="padding-left:2%;">HIW | Admin Login</h1>
    ...
    <form action="#" method="post" class="w3-container w3-card-4 w3-light-grey" style="font:arial;padding-left:3%; margin-left:23%; margin-right:30%; margin-top:15%; margin-bottom:1%;">
        <br><br><label for="name" style="padding-left:60px;">Username :</label>
        <input type="text" name="name" size="50" id="name"  placeholder="Enter your Username" required><br><br>
        <label for="password" style="padding-left:60px;">Password :</label>
        <input type="password" name="password" size="50" id="password" placeholder="Enter your Password" required><br><br>
