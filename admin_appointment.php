...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from appointment_data where name = '".$_GET['name']."'");
...
<nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand" style="padding-left:2%;">HIW | Appointments List</h1>
...
?>
    ...
    <tr align="center">
        ...
        <td>
	      <a href="admin_appointment.php?name=<?php echo $row['name']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><button>Remove</button></i></a>
        </div></td>
    </tr>
